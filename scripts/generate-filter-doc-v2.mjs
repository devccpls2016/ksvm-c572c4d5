...
nodes.push(
  ...
  P([T("सर्व सर्वेक्षणे — शोध व फिल्टर (आवृत्ती २)", { bold: true, size: 34, color: C.accent })],
    { alignment: AlignmentType.CENTER, after: 60 }),
  P([T("All Surveys — Search & Filter : Complete Structure (v2 — every field, no omissions)", { size: 24, color: C.en })],
...
/* ---------- 11.5 Master field index ---------- */
nodes.push(Br());
nodes.push(H1("१२. संपूर्ण फिल्टर अनुक्रमणिका (Master Field Index)"));
nodes.push(P([T("खालील तक्त्यात \u0936\u094b\u0927 व फिल्टर विभागातील प्रत्येक field, तिचा गट, नियंत्रण प्रकार, data key व जुळणी स्तर दिलेला आहे — एकही field वगळलेली नाही.", { size: 21 })], { after: 80 }));

const CW = [520, 2100, 1600, 2000, 3140];
...
const FIELD_INDEX = [
  ["loc", "राज्य (State)", "Select", "state", "कुटुंब-स्तर · exact"],
  ["loc", "जिल्हा (District)", "MultiSelect", "districts[]", "कुटुंब-स्तर · OR · exact"],
  ["loc", "तालुका (Taluka)", "MultiSelect", "talukas[]", "जिल्ह्यावर अवलंबून · OR"],
  ["loc", "गाव (Village)", "MultiSelect", "villages[]", "तालुक्यावर अवलंबून · OR"],
  ["loc", "पिनकोड (Pincode)", "MultiSelect", "pincodes[]", "गावावर अवलंबून · OR"],
  ["fam", "लिंग (Gender)", "MultiSelect", "genders[]", "व्यक्ती-स्तर · कोणतीही व्यक्ती"],
  ["fam", "वयोगट (Age Group)", "MultiSelect", "ageGroups[]", "व्यक्ती-स्तर · श्रेणी"],
  ["fam", "वय श्रेणी (Age Range)", "RangeInput", "ageMin / ageMax", "व्यक्ती-स्तर · age किंवा dob"],
  ["fam", "वैवाहिक स्थिती (Marital Status)", "MultiSelect", "maritalStatuses[]", "व्यक्ती-स्तर · exact"],
  ["fam", "विवाहाचा प्रकार (Marriage Type)", "MultiSelect", "marriageTypes[]", "व्यक्ती-स्तर · contains"],
  ["fam", "जोडीदाराची जात (Spouse Caste)", "TextFilter", "spouseCaste", "व्यक्ती-स्तर · contains"],
  ["fam", "कुटुंब आकार (Family Size)", "MultiSelect", "familySizes[]", "कुटुंब-स्तर · श्रेणी"],
  ["fam", "कुटुंब आकार श्रेणी", "RangeInput", "familyMin / familyMax", "कुटुंब-स्तर · संख्या"],
  ["edu", "शिक्षण स्तर (Level)", "MultiSelect", "eduLevels[]", "व्यक्ती-स्तर · exact"],
  ["edu", "शाखा / गट (Stream)", "MultiSelect", "eduStreams[]", "स्तरावर अवलंबून"],
  ["edu", "अभ्यासक्रम (Course)", "MultiSelect", "eduCourses[]", "स्तर + शाखेवर अवलंबून"],
  ["edu", "संस्था प्रकार (Institution Type)", "MultiSelect", "eduInstitutions[]", "व्यक्ती-स्तर · exact"],
  ["occ", "मुख्य श्रेणी (Category)", "MultiSelect", "occCategories[]", "व्यक्ती-स्तर · exact"],
  ["occ", "रोजगार प्रकार (Employment Type)", "MultiSelect", "employmentTypes[]", "श्रेणीवरून नकाशा"],
  ["occ", "विभाग / संस्था (Department)", "TextFilter", "department", "८ उप-fields मध्ये contains"],
  ["occ", "पदनाम (Designation)", "MultiSelect", "designations[]", "designation किंवा rank"],
  ["occ", "व्यवसाय प्रकार (Business Type)", "MultiSelect", "occBusinessTypes[]", "businessType(s) / selfEmployedTypes"],
  ["agri", "शेती आहे का? (Has Farmland)", "TriSelect", "hasFarmland", "कुटुंब-स्तर · boolean"],
  ["agri", "जमिनीचे क्षेत्र (Land Size)", "MultiSelect", "landSizes[]", "कुटुंब-स्तर · exact"],
  ["agri", "क्षेत्र श्रेणी (Land Area)", "RangeInput", "landMin / landMax", "बागायती + कोरडवाहू एकर"],
  ["agri", "हंगाम (Crop Season)", "MultiSelect", "cropSeasons[]", "crops[].season + क्षेत्र"],
  ["agri", "प्रमुख पीक प्रकार (Major Crop Type)", "MultiSelect", "majorCropTypes[]", "OR · array contains"],
  ["agri", "सिंचन स्रोत (Irrigation Source)", "MultiSelect", "irrigationSources[]", "key तपशील किंवा यादी"],
  ["agri", "पंप प्रकार (Pump Type)", "MultiSelect", "pumpTypes[]", "कोणत्याही स्रोतावर"],
  ["agri", "कोहळी मालगुजारी तलाव", "TriSelect", "malguzariPond", "pond.is_kohli_malguzari"],
  ["agri", "मोफत सिंचन पाणी", "TriSelect", "freeWater", "कोणताही स्रोत"],
  ["agri", "शेतीचा प्रकार (Farming Type)", "MultiSelect", "farmingTypes[]", "व्यक्तींच्या व्यवसाय तपशिलातून"],
  ["agri", "शेती साधने (Equipment)", "MultiSelect", "farmingTools[]", "६ साधन keys"],
  ["agri", "साधन मालकी (Ownership)", "Select", "toolOwnership", "own / not_own"],
  ["agri", "खरेदी करण्याची इच्छा?", "TriSelect", "toolWantBuy", "साधन तपशील want_to_buy"],
  ["agri", "कर्जाची आवश्यकता? (साधन)", "TriSelect", "toolLoan", "साधन तपशील needs_loan"],
  ["agri", "ठेका / बटाई शेती", "TriSelect", "contractFarming", "farm_management"],
  ["agri", "ठेका / बटाई क्षेत्र", "RangeInput", "contractMin / contractMax", "एकर संख्या"],
  ["house", "स्वतःचे घर? (Own House)", "TriSelect", "ownsHouse", "कुटुंब-स्तर"],
  ["house", "घराचा प्रकार (House Type)", "MultiSelect", "houseTypes[]", "exact"],
  ["house", "निवास स्थिती (Living Status)", "MultiSelect", "livingStatuses[]", "exact"],
  ["house", "घरकुल लाभ मिळाला?", "TriSelect", "gharkulReceived", "boolean"],
  ["house", "घरकुल आवश्यक?", "TriSelect", "gharkulWanted", "boolean"],
  ["house", "सोलर बसविले?", "TriSelect", "solarInstalled", "boolean"],
  ["house", "सोलर आवश्यक?", "TriSelect", "solarWanted", "boolean"],
  ["house", "घरगुती वस्तू (Assets)", "MultiSelect", "assets[]", "AND — सर्व वस्तू असाव्यात"],
  ["house", "वस्तू किमान संख्या (Min Qty)", "Select 1+…10+", "assetMinQty", "प्रत्येक निवडलेल्या वस्तूसाठी"],
  ["ben", "लाडकी बहीण लाभार्थी", "TriSelect", "ladkiBahin", "benefits_info"],
  ["ben", "लाभ नियमित मिळतो?", "TriSelect", "ladkiBahinRegular", "benefits_info"],
  ["ben", "कारण (Reason)", "MultiSelect", "ladkiBahinReasons[]", "दोन्ही याद्यांतील कारणे"],
  ["ben", "गंभीर आजार (Critical Illness)", "TriSelect", "criticalIllness", "benefits_info"],
  ["ben", "वैद्यकीय मदत आवश्यक?", "TriSelect", "medicalAidNeeded", "benefits_info"],
  ["ben", "खेळाडू आहे का? (Sportsperson)", "TriSelect", "hasSportsperson", "benefits_info"],
  ["ben", "स्तर (Sport Level)", "MultiSelect", "sportLevels[]", "contains"],
  ["ben", "खेळाचा प्रकार (Sport Type)", "TextFilter", "sportType", "contains"],
  ["pos", "पद आहे का? (Has Position)", "TriSelect", "hasPosition", "कुटुंब-स्तर"],
  ["pos", "पदाचा प्रकार (Type)", "MultiSelect", "positionTypes[]", "पद-नोंद स्तर"],
  ["pos", "आजी / माजी (Status)", "MultiSelect", "positionStatuses[]", "पद-नोंद स्तर"],
  ["pos", "राजकीय स्तर (Political Level)", "MultiSelect", "politicalLevels[]", "पद-नोंद स्तर"],
  ["pos", "पक्ष (Party)", "TextFilter", "party", "party_name + इतर"],
  ["pos", "लोकप्रतिनिधी प्रकार", "MultiSelect", "representativeTypes[]", "पद-नोंद स्तर"],
  ["pos", "भूमिका (Role)", "MultiSelect", "representativeRoles[]", "प्रकारावर अवलंबून"],
  ["pos", "संस्था (Organisation)", "TextFilter", "organisation", "social_org + coop_org_name"],
  ["biz", "उद्योजक आहे का? (Entrepreneur)", "TriSelect", "entrepreneur", "employment_info"],
  ["biz", "व्यवसाय प्रकार (Business Type)", "MultiSelect", "bizTypes[]", "व्यक्ती + वर्णन मजकूर"],
  ["biz", "जोड व्यवसाय (Side Business)", "TriSelect", "sideBusiness", "employment_info"],
  ["biz", "कर्जाची आवश्यकता (Loan)", "TriSelect", "loanRequired", "कोणतीही व्यक्ती"],
  ["biz", "कर्ज रक्कम (Loan Amount)", "RangeInput", "loanMin / loanMax", "₹ लाख श्रेणी"],
  ["biz", "कर्जाचा उद्देश (Loan Purpose)", "MultiSelect", "loanPurposes[]", "contains"],
];
const headerRow = new TableRow({
  tableHeader: true,
  children: ["#", "फिल्टर field", "नियंत्रण", "data key", "जुळणी स्तर / नियम"].map((h, i) =>
...
nodes.push(P([T(`एकूण ${FIELD_INDEX.length} फिल्टर fields + १ मुक्त शोध पट्टी = संपूर्ण शोध व फिल्टर विभाग.`, { bold: true, size: 21, color: C.green })], { before: 120 }));

/* ---------- Education full tree ---------- */
nodes.push(Br());
nodes.push(H1("१३. परिशिष्ट अ — शिक्षण पर्यायांचे संपूर्ण झाड (Education Options Tree)"));
nodes.push(P([T("शिक्षण गटातील स्तर → शाखा → अभ्यासक्रम या तिन्ही MultiSelect fields मध्ये उपलब्ध होणारे सर्व पर्याय.", { size: 20, color: C.muted })], { after: 80 }));
EDUCATION_TREE.forEach((l) => {
  nodes.push(H2(l.level));
  l.streams.forEach((s) => {
    nodes.push(H3(s.stream === "—" ? "शाखा नाही (No stream)" : s.stream));
    if (!s.courses || s.courses.length === 0) nodes.push(Opt("अभ्यासक्रम नाही", 700));
...
/* ---------- Toolbar & behaviour ---------- */
nodes.push(Br());
nodes.push(H1("१४. परिशिष्ट ब — विभागाचे वर्तन (Section Behaviour)"));
[
  "फिल्टर पूर्णपणे client-side आहेत — कोणतीही अतिरिक्त क्वेरी न करता निकाल तात्काळ बदलतो.",
  "शीर्षकात दिसणारी संख्या = फिल्टरनंतर उरलेल्या नोंदी / एकूण नोंदी.",
  "Excel व PDF निर्यात नेहमी फिल्टर लागू झालेल्या नोंदींवरच होते (जे दिसते तेच निर्यात होते).",
  "प्रत्येक नोंदीवर पाहा / संपादन / PDF हे तीन पर्याय फिल्टरनंतरही तसेच काम करतात.",
  "वापरकर्त्याच्या प्रवेश कक्षेनुसार (जिल्हा / तालुका / गाव) आधीच मर्यादित डेटा येतो; फिल्टर त्या डेटावर पुढील गाळणी करतात.",
  "MultiSelect मधील अंतर्गत शोध पट्टी लांब याद्यांमध्ये (पदनाम, अभ्यासक्रम) पर्याय शोधण्यासाठी आहे.",
  "रीसेट: मुख्य पानावर सर्व ९ गट मोकळे होतात; dashboard मधील विभागनिहाय panel मध्ये फक्त त्या विभागाचे गट मोकळे होतात.",
].forEach((s) => nodes.push(B(s, 0, { size: 21 })));

/* ---------- 12. Reuse ---------- */
nodes.push(Br());
nodes.push(H1("१५. गटांचा पुनर्वापर व सक्रिय गणना (Group Reuse & Active Count)"));
...
const out = "/mnt/documents/All-Surveys-Shodh-va-Filter-Complete-Structure_v2.docx";
